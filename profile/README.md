...
Active contributors in ML/LLM, RAG, and application development. Here are our key projects:
...
- **[Filer.Basis](https://github.com/iyulab/Filer.Basis)** - Sync local filesystem as RAG-enabled memory storage

### 🛠️ Development Tools
- **[formdown](https://formdown.dev)** - Markdown-inspired forms with built-in validation, real-time processing, and framework flexibility
- **[DocuChef](https://github.com/iyulab/DocuChef)** - Template-based document generation for Excel, Word, and PowerPoint
- **[FlexiPane.WPF](https://github.com/iyulab/FlexiPane.WPF)** - Dynamic screen splitting and pane management for WPF applications
